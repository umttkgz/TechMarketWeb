...
namespace TechMarket.DataAccess.Migrations
{
    ...
    [Migration("20240326135157_addOrderHeaderAndDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechMarket.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechMarket.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechMarket.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechMarket.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TechMarket.Models.OrderDetail", b =>
                {
                    b.HasOne("TechMarket.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("TechMarket.Models.OrderHeader", b =>
                {
                    b.HasOne("TechMarket.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TechMarket.Models.ApplicationUser", b =>
                {
                    b.HasOne("TechMarket.Models.Company", "Company")
                        .WithMany()
